...
def evaluate_shrec2020(pred_list,
					   base_dir='/data/su_xiaofeng/shrec_data/shrec2020_full_dataset',
...
def evaluate_10045(pred_list,coords_file,
				   base_dir='/storage_data/su_xiaofeng/relion/empiar-10045/build_targets',
				   ):
	pred_list = np.array(pred_list).reshape(-1,6)
...
if __name__ == '__main__':
	final_pred_list = [665,747,25,6,1,1]

	fscore = evaluate_10045(final_pred_list,base_dir='/storage_data/su_xiaofeng/relion/empiar-10045/build_targets/eval_data/eval/eval.mrc',
                                        coords_file='/storage_data/su_xiaofeng/relion/empiar-10045/build_targets/eval_data/eval/IS002_291013_006.coords')
