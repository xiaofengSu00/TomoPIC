...
def create_parser():
	...
	# 					default='/storage_data/su_xiaofeng/relion/particle_pick',
    ...
    parser.add_argument('--detect_size', type=int, default=40, help='the number of class')
    parser.add_argument("--padding_size", type=int, default=12, help="Size of each image batch.")
