...
def create_parser():
    ...
    parser.add_argument('--load_dir', type=str, default='./checkpoints_10045', help='The directory of the pretrained model.')
#checkpoints_10045/train_eval1_510
    ...
    parser.add_argument('--output_dir', type=str, default='./result',
						help='the directory of saving the prediction result.')
...
def predict(opt):
    ...
    if os.path.exists(opt.output_dir):
        ...
        print(f"Removed existing directory: {opt.output_dir}")
    ...
    for tomo in data_range:
        ...
        with torch.no_grad():
            ...
            save_file = opt.output_dir + '/' + data_name + '.txt'
            # save_file = './result/{}.txt'.format(data_name)
