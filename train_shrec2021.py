...
def train(opt):
	...
	train_dataset = SHREC2021(mode='train', base_dir=opt.dataset_dir,aug_choice=4)
	...
	eval_dataset = SHREC2021(mode='val', base_dir=opt.dataset_dir, aug_choice=4)
	...
	early_stopping = EarlyStopping(save_path=opt.save_dir, patience=10)
